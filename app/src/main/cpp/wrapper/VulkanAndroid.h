...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "ByteFlow", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "ByteFlow", __VA_ARGS__))
#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "ByteFlow", __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "ByteFlow", __VA_ARGS__))
