...
namespace vkglTF
{
	...
	*/
	struct Texture {
		...
		void destroy();
		void fromglTfImage(AAssetManager* assetManager, tinygltf::Image& gltfimage, std::string path, vks::VulkanDevice* device, VkQueue copyQueue);
	};
	...
	*/
	...
	public:
		...
		void loadImages(AAssetManager* assetManager, tinygltf::Model& gltfModel, vks::VulkanDevice* device, VkQueue transferQueue);
		void loadMaterials(tinygltf::Model& gltfModel);
		void loadAnimations(tinygltf::Model& gltfModel);
		void loadFromFile(AAssetManager* assetManager, std::string filename, vks::VulkanDevice* device, VkQueue transferQueue, uint32_t fileLoadingFlags = vkglTF::FileLoadingFlags::None, float scale = 1.0f);
