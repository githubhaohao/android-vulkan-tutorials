...
void VulkanSwapChain::initSurface(uint32_t outputWidth, uint32_t outputHeight)
...
#endif
{
	...
	createDirect2DisplaySurface(outputWidth, outputHeight);
#elif defined(VK_USE_PLATFORM_DIRECTFB_EXT)
...
/** 
* Create the swapchain and get its images with given outputWidth and outputHeight
* 
* @param width Pointer to the outputWidth of the swapchain (may be adjusted to fit the requirements of the swapchain)
* @param height Pointer to the outputHeight of the swapchain (may be adjusted to fit the requirements of the swapchain)
...
void VulkanSwapChain::create(uint32_t *width, uint32_t *height, bool vsync, bool fullscreen)
{
	...
	// If outputWidth (and outputHeight) equals the special value 0xFFFFFFFF, the size of the surface will be set by the swapchain
...
*/	
void VulkanSwapChain::createDirect2DisplaySurface(uint32_t outputWidth, uint32_t outputHeight)
{
	...
	for(uint32_t i = 0; i < displayPropertyCount;++i)
	{
		...
		for (uint32_t j = 0; j < modeCount; ++j)
		{
			...
			if (mode->parameters.visibleRegion.outputWidth == outputWidth && mode->parameters.visibleRegion.outputHeight == outputHeight)
			{
	...
	surfaceInfo.imageExtent.width = outputWidth;
	surfaceInfo.imageExtent.height = outputHeight;
