...
namespace vks
{
	...
	ktxResult Texture::loadKTXFile(AAssetManager* assetManager,std::string filename, ktxTexture **target)
	{
	...
	*
	*/
	void Texture2D::loadFromFile(AAssetManager* assetManager, std::string filename, VkFormat format, vks::VulkanDevice *device, VkQueue copyQueue, VkImageUsageFlags imageUsageFlags, VkImageLayout imageLayout, bool forceLinear)
	{
		ktxTexture* ktxTexture;
		ktxResult result = loadKTXFile(assetManager, filename, &ktxTexture);
	...
	*
	*/
	void Texture2DArray::loadFromFile(AAssetManager* assetManager, std::string filename, VkFormat format, vks::VulkanDevice *device, VkQueue copyQueue, VkImageUsageFlags imageUsageFlags, VkImageLayout imageLayout)
	{
		ktxTexture* ktxTexture;
		ktxResult result = loadKTXFile(assetManager, filename, &ktxTexture);
		assert(result == KTX_SUCCESS);
	...
	*
	*/
	void TextureCubeMap::loadFromFile(AAssetManager* assetManager, std::string filename, VkFormat format, vks::VulkanDevice *device, VkQueue copyQueue, VkImageUsageFlags imageUsageFlags, VkImageLayout imageLayout)
	{
		ktxTexture* ktxTexture;
		ktxResult result = loadKTXFile(assetManager, filename, &ktxTexture);
		assert(result == KTX_SUCCESS);
