...
namespace vks
{
	namespace debug
	{
			...
			void* pUserData)
		{
            ...
            LOGE("MessageIdNumber:%d, MessageIdName:%s, Message:%s", pCallbackData->messageIdNumber, pCallbackData->pMessageIdName, pCallbackData->pMessage);

			// Display message to default output (console/logcat)
			std::stringstream debugMessage;
//			debugMessage << prefix << "[" << pCallbackData->messageIdNumber << "][" << (pCallbackData->pMessageIdName !=
//                                                                                                nullptr ? pCallbackData->pMessageIdName : 0) << "] : " << (pCallbackData->pMessage!=
//                                                                                                                                                           nullptr ? pCallbackData->pMessage : 0);
