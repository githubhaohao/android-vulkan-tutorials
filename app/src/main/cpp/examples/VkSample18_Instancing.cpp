...
VkSample18_Instancing::VkSample18_Instancing() {
    LOGCATE("VkSample18_Instancing::VkSample18_Instancing()");
    title = "VkSample18_Instancing";
    pTexture2D = nullptr;
...
float VkSample18_Instancing::rnd(float range)
{
    std::uniform_real_distribution<float> rndDist(0.0f, range);
    return rndDist(rndEngine);
}

void VkSample18_Instancing::updateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY)
{
    LOGCATE("VkSample18_Instancing::updateTransformMatrix()");
...
void VkSample18_Instancing::prepareInstanceData()
{
...
void VkSample18_Instancing::updateInstanceData() {
    for (auto i = 0; i < INSTANCE_COUNT / 2; i++) {
...
void VkSample18_Instancing::createUniformBuffers() {
...
void VkSample18_Instancing::generateSpheres()
{
...
void VkSample18_Instancing::setupDescriptors()
{
    // Pool
...
void VkSample18_Instancing::createPipelines()
{
    // Layout
...
void VkSample18_Instancing::buildCommandBuffers()
{
...
void VkSample18_Instancing::loadTexture()
{
    if(pTexture2D) {
        pTexture2D->destroy();
        delete pTexture2D;
...
void VkSample18_Instancing::prepare() {
...
void VkSample18_Instancing::render() {
    if (!prepared)
        return;
