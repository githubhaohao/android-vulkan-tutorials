...
#ifndef ANDROID_VULKAN_TUTORIALS_VKSAMPLE03_TEXTUREMAPPING_H
#define ANDROID_VULKAN_TUTORIALS_VKSAMPLE03_TEXTUREMAPPING_H
#include "vulkanexamplebase.h"
#include "VkSampleBase.h"

class VkSample03_TextureMapping : public VkSampleBase {
public:
    VkSample03_TextureMapping();
    virtual ~VkSample03_TextureMapping();
    void loadTexture();
...
#endif //ANDROID_VULKAN_TUTORIALS_VKSAMPLE03_TEXTUREMAPPING_H
