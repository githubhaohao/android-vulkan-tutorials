...
#ifndef ANDROID_VULKAN_TUTORIALS_VKSAMPLE10_SPECIALIZATIONINFO_H
#define ANDROID_VULKAN_TUTORIALS_VKSAMPLE10_SPECIALIZATIONINFO_H
#include "vulkanexamplebase.h"
#include "VkSampleBase.h"

class VkSample10_SpecializationInfo : public VkSampleBase {
public:
    VkSample10_SpecializationInfo();
    virtual ~VkSample10_SpecializationInfo();
    void loadTexture();
...
#endif //ANDROID_VULKAN_TUTORIALS_VKSAMPLE10_SPECIALIZATIONINFO_H
