...
VkSample09_RenderI444::VkSample09_RenderI444() {

    title = "VkSample09_RenderI444";
...
void VkSample09_RenderI444::updateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY)
{
    LOGCATE("VkSample09_RenderI444::updateTransformMatrix()");
...
void VkSample09_RenderI444::loadImage(NativeImage *pImage)
{
    LOGCATE("VkSample09_RenderI444::loadImage() pImage = %p", pImage->ppPlane[0]);
...
void VkSample09_RenderI444::createVertexBuffer() {
...
void VkSample09_RenderI444::createDescriptors() {
    // Pool
...
void VkSample09_RenderI444::createPipelines() {
    // Layout
...
void VkSample09_RenderI444::createUniformBuffers() {
...
void VkSample09_RenderI444::buildCommandBuffers()
{
...
void VkSample09_RenderI444::loadTexture()
{
...
void VkSample09_RenderI444::prepare() {
...
void VkSample09_RenderI444::render() {
    if (!prepared)
        return;
