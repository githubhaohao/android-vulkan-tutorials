...
#ifndef ANDROID_VULKAN_TUTORIALS_VKSAMPLE15_STENCILTESTING_H
#define ANDROID_VULKAN_TUTORIALS_VKSAMPLE15_STENCILTESTING_H
#include "vulkanexamplebase.h"
#include "VkSampleBase.h"

class VkSample15_StencilTesting : public VkSampleBase {
public:
    VkSample15_StencilTesting();
    virtual ~VkSample15_StencilTesting();
    void loadTexture();
...
#endif //ANDROID_VULKAN_TUTORIALS_VKSAMPLE15_STENCILTESTING_H
