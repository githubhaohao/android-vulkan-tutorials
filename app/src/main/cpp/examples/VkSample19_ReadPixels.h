//
// Created by 字节流动 on 2024/11/11.
//

#ifndef ANDROID_VULKAN_TUTORIALS_VkSample19_ReadPixels_H
#define ANDROID_VULKAN_TUTORIALS_VkSample19_ReadPixels_H
...
class VkSample19_ReadPixels : public VkSampleBase {
public:
    VkSample19_ReadPixels();
    virtual ~VkSample19_ReadPixels();
    void loadTexture();
...
#endif //ANDROID_VULKAN_TUTORIALS_VkSample19_ReadPixels_H
