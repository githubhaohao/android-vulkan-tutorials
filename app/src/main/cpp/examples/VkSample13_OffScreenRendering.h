...
#ifndef ANDROID_VULKAN_TUTORIALS_VKSAMPLE13_OFFSCREEN_RENDERING_H
#define ANDROID_VULKAN_TUTORIALS_VKSAMPLE13_OFFSCREEN_RENDERING_H
#include "vulkanexamplebase.h"
#include "VkSampleBase.h"

class VkSample13_OffScreenRendering : public VkSampleBase {
public:
    VkSample13_OffScreenRendering();
    virtual ~VkSample13_OffScreenRendering();
    void loadTexture();
...
public:
    ...
    VkDescriptorSet descriptorSet{ VK_NULL_HANDLE }, descriptorSet2{ VK_NULL_HANDLE };

    vks::Texture2D* pTexture2D;
};
#endif //ANDROID_VULKAN_TUTORIALS_VKSAMPLE13_OFFSCREEN_RENDERING_H
