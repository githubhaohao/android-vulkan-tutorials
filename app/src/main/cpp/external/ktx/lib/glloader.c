 ...
 * @param[out] pTarget     @p *pTarget is set to the texture target used. The
 *                         target is chosen based on the file contents.
 * @param[out] pDimensions If @p pDimensions is not NULL, the outputWidth, outputHeight and
 ...
 *                          ktxLoadTextureF() for details.
 * @param[out] pDimensions  @p the texture's base level outputWidth depth and outputHeight
