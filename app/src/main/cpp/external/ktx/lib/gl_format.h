...
void glTexImage2D( GLenum target, GLint level, GLint internalFormat,
	GLsizei outputWidth, GLsizei outputHeight, GLint border,
	GLenum format, GLenum type, const GLvoid * data );
void glTexImage3D( GLenum target, GLint level, GLint internalFormat,
	GLsizei outputWidth, GLsizei outputHeight, GLsizei depth, GLint border,
	GLenum format, GLenum type, const GLvoid * data );
...
void glTexStorage2D( GLenum target, GLsizei levels, GLenum internalformat,
	GLsizei outputWidth, GLsizei outputHeight );
void glTexStorage3D( GLenum target, GLsizei levels, GLenum internalformat,
	GLsizei outputWidth, GLsizei outputHeight, GLsizei depth );
