 ...
 *                             0 to 5.
 * @param [in] width           outputWidth of the image.
 * @param [in] height          outputHeight of the image or, for 1D textures
 *                             textures, 1.
...
@li Incorrect block outputWidth and outputHeight calculations for sizes that are not
