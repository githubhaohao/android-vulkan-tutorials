...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  // can be stored in the same space as a scalar type of this bit outputWidth.
  ...
  // The relative outputHeight of this plane. A value of k means that this plane is 1/k the outputHeight of the overall format.
  ...
  // The relative outputWidth of this plane. A value of k means that this plane is 1/k the outputWidth of the overall format.
