...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // Most "big" widgets share a common outputWidth settings by default.
    //ImGui::PushItemWidth(ImGui::GetWindowWidth() * 0.65f);    // Use 2/3 of the space for widgets and 1/3 for labels (default)
    ImGui::PushItemWidth(ImGui::GetFontSize() * -12);           // Use fixed outputWidth for labels (by passing a negative value), the rest goes to widgets. We choose a outputWidth proportional to our font size.
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Text"))
        {
            ...
            if (ImGui::TreeNode("Word Wrapping"))
            {
                ...
                ImGui::SliderFloat("Wrap outputWidth", &wrap_width, -20, 600, "%.0f");
        ...
        if (ImGui::TreeNode("Images"))
        {
            ...
            // If you decided that ImTextureID = MyEngineTexture*, then you can pass your MyEngineTexture* pointers to ImGui::Image(), and gather outputWidth/outputHeight through your own functions, etc.
            ...
            ImGui::TextWrapped("And now some offscreen1 buttons..");
        ...
        if (ImGui::TreeNode("Plots Widgets"))
        {
            ...
            // Typically we would use ImVec2(-1.0f,0.0f) to use all available outputWidth, or ImVec2(outputWidth,0.0f) for a specified outputWidth. ImVec2(0.0f,0.0f) uses ItemWidth.
    ...
    if (ImGui::CollapsingHeader("Layout"))
    {
        ...
        if (ImGui::TreeNode("Widgets Width"))
        {
            ...
            ImGui::SameLine(); ShowHelpMarker("Fixed outputWidth.");
            ImGui::PushItemWidth(100);
            ImGui::DragFloat("float##1", &f);
            ImGui::PopItemWidth();

            ImGui::Text("PushItemWidth(GetWindowWidth() * 0.5f)");
            ImGui::SameLine(); ShowHelpMarker("Half of window outputWidth.");
            ImGui::PushItemWidth(ImGui::GetWindowWidth() * 0.5f);
            ImGui::DragFloat("float##2", &f);
            ImGui::PopItemWidth();

            ImGui::Text("PushItemWidth(GetContentRegionAvailWidth() * 0.5f)");
            ImGui::SameLine(); ShowHelpMarker("Half of available outputWidth.\n(~ right-cursor_pos)\n(works within a column set)");
        ...
        if (ImGui::TreeNode("Horizontal Scrolling"))
        {
            ...
            ImGui::Bullet(); ImGui::TextWrapped("You may want to explicitly specify content outputWidth by calling SetNextWindowContentWidth() before Begin().");
            static int lines = 7;
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // If your items are of variable size you may want to implement code similar to what ImGuiListClipper does. Or split your data into fixed outputHeight items to allow random-seeking into your list.
