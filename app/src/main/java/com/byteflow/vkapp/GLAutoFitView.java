...
public class GLAutoFitView extends GLSurfaceView implements ScaleGestureDetector.OnScaleGestureListener {
...
//    }
    ...
    public GLAutoFitView(Context context, GLRenderer glRender) {
        this(context, glRender, null);
    }

    public GLAutoFitView(Context context, GLRenderer glRender, AttributeSet attrs) {
        super(context, attrs);
        this.setEGLContextClientVersion(2);
        mGLRender = glRender;
        /*If no setEGLConfigChooser method is called,
